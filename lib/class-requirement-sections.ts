...
export const CLASS_REQUIREMENT_SECTIONS: Partial<Record<string, ClassRequirementSection[]>> = {
  amigo: [
    ...
    },
    {
      ...
      items: [
        ...
        "a) Creación: Lo que Dios creó en cada día de la creación.",
        "b) 10 Plagas: Qué plagas cayeron sobre Egipto.",
        "c) 12 Tribus: El nombre de cada una de las tribus de Israel.",
        "d) 39 libros de Antiguo Testamento y demostrar habilidad para encontrar cualquiera de ellos.",
        "Leer y explicar los siguientes versículos: Juan 3:16; Efesios 6:1-3; 2 Timoteo 3:16; Salmo 1.",
        "Lectura bíblica: Haga clic aquí.",
      ],
    },
    {
      title: "III. Sirviendo a los demás",
      items: [
        "Dedicar dos horas ayudando a alguien en su comunidad a través de dos de las siguientes actividades:",
        "a) Visitar a alguien que necesita de amistad y orar con esa persona.",
        "b) Ofrecer y llevar alimento a alguien necesitado.",
        "c) Participar de un proyecto ecológico o educativo.",
  ...
  companero: [
    ...
    {
      title: "II. Descubrimiento espiritual - Compañero",
      items: [
        "Memorizar y demostrar su conocimiento en:",
        "a) 10 Mandamientos: La Ley de Dios dada a Moisés.",
        "b) 27 libros del Nuevo Testamento y demostrar habilidad para encontrar cualquiera de ellos.",
    ...
    {
      title: "III. Sirviendo a los demás - Compañero",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "a) Natación I, avanzado",
        "b) Campamento II",
      ],
    },
    {
      title: "VI. Organización y liderazgo - Compañero",
      items: [
    ...
    {
      title: "VII. Estudio de la naturaleza - Compañero",
      items: [
    ...
    {
      title: "VIII. Arte de acampar - Compañero",
      items: [
    ...
    {
      title: "IX. Estilo de vida - Compañero",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "Escoger uno de los siguientes ítems:",
        "a) Asistir a un curso «Cómo dejar de fumar»",
        "b) Asistir a dos películas sobre salud",
        "c) Elaborar un afiche sobre el prejuicio de las drogas",
        "d) Ayudar a preparar material para una exposición o demostración sobre la salud",
        "e) Realizar por internet una búsqueda sobre salud y escribir una página con los resultados encontrados",
        "Identificar y escribir doce aves nativas y doce árboles nativos.",
        "Participar de una de las siguientes ceremonias sugiriendo ideas creativas de cómo realizarlas:",
        "a) Investidura",
        "b) Ceremonia de entrega de pañoletas",
        "c) Día Mundial de los Conquistadores",
        ...
        "Completar una especialidad, no realizada anteriormente, en una de las siguientes áreas:",
        "a) Artes domésticas",
        "b) Salud y ciencia",
        "c) Crecimiento espiritual, actividades misioneras y herencia",
  ...
  explorador: [
    {
      title: "I. Generales - Explorador",
      items: [
        "Tener como mínimo doce años de edad.",
        "Ser miembro activo del Club de Conquistadores.",
        "Demostrar su comprensión del significado de la Ley de los Conquistadores a través de una de las siguientes actividades:",
        "a) Representación",
        "b) Debate",
        "c) Redacción",
    ...
    {
      title: "II. Descubrimiento Espiritual - Explorador",
      items: [
        "Memorizar y demostrar su conocimiento:",
        "a) Levítico 11: ¿Cuáles son los animales comestibles y cuáles no? Explicar por qué.",
        ...
        "Lectura bíblica: Haga clic aquí.",
        "Discutir con su líder, escoger uno de los siguientes pasajes:",
        "a) Juan 3 - Nicodemo",
        "b) Juan 4 - La mujer samaritana",
        "c) Lucas 10 - El buen samaritano",
        "d) Lucas 15 - El hijo pródigo",
        "e) Lucas 19 - Zaqueo",
        "Utilizando el pasaje escogido, demostrar su comprensión de cómo Jesús salva a las personas, usando uno de los siguientes métodos:",
    ...
    {
      title: "III. Sirviendo a Otros - Explorador",
      items: [
    ...
    {
      title: "IV. Desarrollo de Amistad - Explorador",
      items: [
    ...
    {
      title: "V. Salud y Aptitud Física - Explorador",
      items: [
        "Escoger una de las siguientes actividades y escribir un texto personal de un estilo de vida libre del alcohol:",
        "a) Participar en un debate en clase sobre los efectos del alcohol en el organismo.",
        "b) Ver video sobre el efecto del alcohol u otras drogas en el cuerpo humano y debatir sobre el asunto.",
      ],
    },
    {
      title: "VI. Organización y Desarrollo de Liderazgo - Explorador",
      items: [
    ...
    {
      title: "VII. Estudio de la Naturaleza - Explorador",
      items: [
        ...
        "c) Climatología",
        "d) Flores",
        "e) Huellas de animales",
      ],
    },
    {
      title: "VIII. Vida al Aire Libre - Explorador",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "Invitar a una persona para asistir a uno de los siguientes programas:",
        "a) Club de Conquistadores",
        "b) Clase bíblica",
        "c) Grupo pequeño",
        "Completar una de las siguientes especialidades:",
        "a) Modales y apariencia cristiana",
        "b) Vida familiar",
        ...
        "Participar en la organización de uno de los eventos especiales del club:",
        "a) Investidura",
        "b) Ceremonia de entrega de pañoletas",
        "c) Día del Conquistador",
        ...
        "Enviar y recibir un mensaje a través de una de las siguientes formas:",
        "a) Alfabeto con semáforos",
        "b) Código Morse, con linterna",
        "c) Alfabeto de sordomudos (lenguaje con señales)",
        "d) Alfabeto Braille",
        "Completar una especialidad, no realizada anteriormente, en una de las siguientes áreas:",
        "a) Artes domésticas",
        "b) Salud y ciencia",
  ...
  pionero: [
    ...
    {
      title: "III. Sirviendo a los demás - Pionero",
      items: [
    ...
    {
      title: "IV. Desarrollo de la amistad - Pionero",
      items: [
        "Participar en un debate y hacer una evaluación personal sobre sus actividades en dos de los siguientes temas:",
        "a) Autoestima",
        "b) Amistad",
        "c) Relacionamientos",
    ...
    {
      title: "V. Salud y aptitud física - Pionero",
      items: [
    ...
    {
      title: "VI. Organización y liderazgo - Pionero",
      items: [
        "Asistir a un seminario o entrenamiento ofrecido por su iglesia o distrito en los siguientes departamentos:",
    ...
    {
      title: "VII. Estudio de la naturaleza - Pionero",
      items: [
    ...
    {
      title: "VIII. Arte de acampar - Pionero",
      items: [
    ...
    {
      title: "IX. Estilo de vida - Pionero",
      items: [
        "Completar una especialidad no realizada anteriormente en una de las siguientes áreas:",
    ...
    },
    {
      ...
      items: [
        ...
        "Participar de una de las siguientes actividades, presentando al final un informe escrito de mínimo dos páginas:",
        "a) Caminar 10 km",
        "b) Cabalgar 2 km",
        ...
        "e) Nadar 200 m",
        "f) Correr 1500 m",
        "g) Rodar 2 km en patines o roller",
        ...
        "Completar uno de los siguientes ítems:",
        ...
        "Buscar e identificar, a través de fotografías, exposición o en vivo, uno de los siguientes ítems:",
  ...
  excursionista: [
    {
      title: "I. Generales - Excursionista",
      items: [
    ...
    {
      title: "II. Descubrimiento espiritual - Excursionista",
      items: [
        "Memorizar y demostrar su conocimiento:",
        "a) Apóstoles: El nombre de los 12 apóstoles de Cristo.",
        "b) El Fruto del Espíritu: La relación de adjetivos al carácter del cristiano.",
    ...
    {
      title: "III. Sirviendo a los demás - Excursionista",
      items: [
        ...
        "Debatir cómo los jóvenes adventistas se deben relacionar con las personas en las diferentes situaciones del diario vivir, tales como:",
        "a) Vecindario",
        "b) Escuela",
    ...
    {
      title: "IV. Desarrollo de la amistad - Excursionista",
      items: [
        "En una conversación o evaluación personal, examinar tus actitudes de dos de los siguientes temas:",
        "a) Autoestima",
        "b) Relacionamiento familiar",
    ...
    {
      title: "V. Salud y aptitud física - Excursionista",
      items: ["Completar la especialidad de Temperanza."],
    },
    {
      title: "VI. Organización y liderazgo - Excursionista",
      items: [
        ...
        "Completar la especialidad de Aventura para Cristo.",
      ],
    },
    {
      title: "VII. Estudio de la naturaleza - Excursionista",
      items: [
    ...
    {
      title: "VIII. Arte de acampar - Excursionista",
      items: [
    ...
    {
      title: "IX. Estilo de vida - Excursionista",
      items: [
        "Completar una especialidad, no realizada anteriormente, de una de las siguientes áreas:",
        "a) Crecimiento espiritual, actividades misioneras y herencia",
    ...
    },
    {
      ...
      items: [
        ...
        "Con la supervisión de su líder o consejero, conversar en su unidad o club sobre uno de los siguientes temas:",
        "a) Modestia cristiana",
        "b) Recreación",
        "c) Salud",
        "d) Observancia del sábado",
        ...
        "Completar la especialidad de Evolución en orden cerrado.",
  ...
  guia: [
    {
      title: "I. Generales - Guía",
      items: [
        "Tener 15 años de edad y/o estar en el décimo grado o su equivalente.",
        "Conocer y entender la Legión de Honor JA.",
        "Ser un miembro activo del Club de Conquistadores.",
        "Memorizar y explicar el Voto y la Ley del Conquistador.",
        "Seleccionar y leer un libro de su elección de la lista del Club de Libros para adolescentes, más un libro acerca de la historia de la iglesia local (seleccionar un libro de su división o país).",
      ],
    },
    {
      title: "II. Descubrimiento espiritual - Guía",
      items: [
        "Discutir cómo el cristiano puede poseer los dones del Espíritu según lo descrito por Pablo en su carta a los Gálatas.",
        "Estudiar y discutir cómo el servicio del santuario del Antiguo Testamento señala a la cruz y al ministerio personal de Jesús.",
        "Leer y bosquejar 3 historias de pioneros adventistas. Contar estas historias durante una reunión de Conquistadores, Sociedad de Jóvenes Adventistas o Escuela Sabática.",
        "Obtener el certificado de Joya de Memoria.",
      ],
    },
    {
      title: "III. Sirviendo a los demás - Guía",
      items: [
        "Como grupo (o individualmente) ayudar a organizar y participar en uno de los siguientes:",
        "a) Hacer una visita de amistad con una persona confinada.",
        "b) Adoptar a una persona o familia en necesidad y ayudarlos.",
        "c) Cualquier otra obra misionera de su elección aprobada por su líder.",
        "Participar en una discusión acerca de testificar a otros adolescentes y poner algunas de las directrices en práctica en una situación real.",
      ],
    },
    {
      title: "IV. Desarrollo de la amistad - Guía",
      items: [
        "En una discusión grupal y mediante una investigación personal, examinar sus actitudes hacia dos de los siguientes temas:",
        "a) Elegir su carrera",
        "b) Conducta moral",
        "c) El sexo y las citas",
        "d) Elegir su esposo",
      ],
    },
    {
      title: "V. Salud y aptitud física - Guía",
      items: [
        "Hacer una presentación a estudiantes de primaria acerca del tema de las leyes de la buena salud.",
        "Completar una de las siguientes actividades:",
        "a) Escribir un poema o artículo para su posible presentación a una de las revistas de salud/temperancia de la iglesia.",
        "b) Individualmente o en grupo, organizar y participar en una «Carrera de Diversión» o actividad similar. Discutir y registrar su programa de entrenamiento físico en preparación para este evento.",
        "c) Leer las páginas 91-111 en el libro La Temperancia por Elena de White y pasar el cuestionario verdadero/falso.",
        "Desarrollar la especialidad de Nutrición o dirigir un grupo por la especialidad de Educación física.",
      ],
    },
    {
      title: "VI. Organización y liderazgo - Guía",
      items: [
        "Después de la discusión, preparar un organigrama de flujo acerca de la organización denominacional, con detalles especiales para su división.",
        "Asistir a un Curso Básico de Entrenamiento para el Personal de Conquistadores patrocinado por su asociación.",
        "Planificar y enseñar por lo menos dos requisitos de cualquier especialidad JA para un grupo de Conquistadores.",
      ],
    },
    {
      title: "VII. Estudio de la naturaleza - Guía",
      items: [
        "Leer la historia de la infancia de Jesús en El Deseado de Todas las Gentes, capítulo 7, y relacionarlo con el estudio de la naturaleza en su educación y ministerio al ir oralmente ante una audiencia acerca de las lecciones originales de naturaleza (parábolas) extraídas de su estudio y observaciones.",
    ...
    {
      title: "VIII. Arte de acampar - Guía",
      items: [
        ...
        "Completar una especialidad no realizada anteriormente que pueda ser contada para una de las Maestrías a seguir:",
        "a) Acuática",
        "b) Deportiva",
        "c) Recreacional",
        "d) Naturalista",
    ...
    },
    {
      ...
      items: [
        ...
        "b) Salud y ciencia",
        "c) Artes domésticas",
        "d) Actividades vocacionales",
      ],
    },
    {
      title: "CLASE AVANZADA: Guía de Exploración",
      items: [
        "Completar la especialidad de Mayordomía.",
        ...
        "a) Traer dos amigos para asistir a dos diferentes reuniones de la iglesia.",
        "b) Ayudar a planificar y participar de mínimo cuatro domingos en una serie de evangelismo joven.",
        "Escribir una página o presentar una charla, de cómo influenciar amigos para Cristo.",
        "Observar por el tiempo de dos meses el trabajo de los diáconos, presentando un informe detallado de sus actividades, conteniendo:",
        ...
        "Completar la Maestría de Naturaleza.",
        "Diseñar tres tipos diferentes de abrigo, explicar su uso y utilizar una de ellas en un campamento.",
        "Asistir a un seminario o presentar una charla sobre dos de los siguientes temas:",
        "a) Aborto",
        "b) Acoso",
        "c) Violencia",
        "d) Drogas",
        "e) Enfermedades de transmisión sexual",
        "Completar la especialidad de Liderazgo al aire libre.",
        "Completar la especialidad de Presupuesto familiar.",
      ],
    },
  ],
}
